...
/*    @Test
    public void test1(){
        ...
        String promptStr = "Given the following text, determine if it is commercial in nature. " +
                "Answer only 'Yes' or 'No'.\n\nText: {input}";

        String testText1 = "This Is Where You Can Learn to Use AI Like a Pro. Cover ChatGPT, automation, generative AI, and more with 150+ hours of instruction for just $29.99.";
        String testText2 = "Microsoft unveils 9 new Copilot features - you can try some now. Marking the company's 50th anniversary, Microsoft's AI companion just got a lot smarter. Even free users can enjoy these.";


        List<ChatMessage> messages = List.of(
                //SystemMessage.from("You should analyze the text and give one-word binary answer (Yes/No) if it's a commercial or not."),
                //SystemMessage.from(""),
                UserMessage.from("Given the following text, determine if it is commercials in nature. Answer only 'Yes' or 'No'.\n\nText: " + testText2)
        );
    ...
    public void test2(){
        ...
        String promptStr = "Given the following text, determine if it's relate to Israel news in nature. " +
                "Answer only 'Yes' or 'No'.\n\nText: {input}";

        String testText1 = "СМИ: Иран нанял киллера из Грузии для ликвидации раввина в Азербайджане . О попытке покушения стало известно в начале 2025 года, но его цель была раскрыта только сейчас.";
        String testText2 = "Погода в Израиле: завтра начнется новая волна жары. На Израиль надвигается новая волна жары. Она начнется уже в воскресенье, 6 апреля. В этот день ожидается значительное повышение температуры.";


        List<ChatMessage> messages = List.of(
                //SystemMessage.from("You should analyze the text and give one-word binary answer (Yes/No) if it's a commercial or not."),
                //SystemMessage.from(""),
                UserMessage.from("Given the following text, determine if it's relate to Israel news in nature. Answer only 'Yes' or 'No'.\n\nText: " + testText2)
        );
    ...
    public void test3(){
        ...
        String promptStr = "List facts mentioned in the given text. Text: ";
        ...
        List<ChatMessage> messages = List.of(
                //SystemMessage.from("You should analyze the text and give one-word binary answer (Yes/No) if it's a commercial or not."),
                //SystemMessage.from(""),
                UserMessage.from("List facts mentioned in the given text.\n\nText: " + testText2)
        );
    ...
    //private String promptPhi4 = "Write a shorts version of the text preserving the original language. text: {0}";
    private String promptPhi4 = "{0}";
    private String systemPromptPhi4 = "Rewrite the provided text in one or two sentences. Preserve the original language and tone.";

    @Test
    public void testRus() {
        //String promptPhi4 = "Rewrite the provided text in one or two sentences. Preserve the original language and tone. text: {0}";
        String testText = "Погода в Израиле: завтра начнется новая волна жары. На Израиль надвигается новая волна жары. Она начнется уже в воскресенье, 6 апреля. В этот день ожидается значительное повышение температуры.";
    ...
    @Test
    public void testEng() {
        //String promptPhi4 = "Rewrite the provided text in one or two sentences while preserving the original language and tone. Do not introduce new elements or alter the original meaning. text: {0}";
